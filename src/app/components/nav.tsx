            ...
            <ul className="m-0 list-none">
              <li>
                <a
                  ...
                  } flex items-center whitespace-nowrap px-7 py-4 hover:rounded-base hover:bg-accentBackground focus:bg-accentBackground`}
                  href="/not-found"
                >
                  Apply now
                </a>
          ...
          <div className="flex flex-col gap-4 mt-auto">
            <a
              className={`inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 ${
                transparent
                  ? "bg-graphTertiary text-interactiveForegroundInversePrimary hover:text-interactiveForegroundPrimary"
                  : "bg-backgroundInverseSecondary text-interactiveForegroundPrimary"
              } hover:bg-accentPrimary h-16 px-12 py-5 w-auto`}
              href="/start"
            >
              <p className="leading-body m-0 p-0 text-left text-base flex flex-col items-center text-current font-bold">
                ...
                <span
                  className={`text-xs font-normal ${
                    transparent ? "text-interactiveSecondary" : ""
                  }`}
                >
          ...
          <li className="mr-2">
            <a
              className={`font-normal transition-all ease-in-out duration-300 ${
                transparent
                  ? "group-hover:bg-backgroundSecondary group-hover:text-textPrimary text-textInversePrimary hover:text-textInversePrimary hover:bg-inherit"
                  : "text-textPrimary hover:bg-backgroundSecondary group-hover:bg-backgroundSecondary"
              }`}
              href="/"
            >
              <svg
              ...
              <span className="">
                <button
                  className={`rounded-full py-1 font-normal transition-all ease-in-out duration-300 h-12 px-4 ${
                    transparent
                      ? "text-textInversePrimary  hover:text-textPrimary group-hover:bg-backgroundSecondary group-hover:text-textPrimary"
                      : "text-textPrimary group-hover:bg-backgroundSecondary"
          ...
          <div className="group min-[520px]:relative">
            <div className="transition-all ease-in-out duration-300 border rounded-full p-2 md:p-3.5 border-strokeBorder group-hover:bg-backgroundSecondary group-hover:border-backgroundSecondary">
              <svg
                ...
                height="18"
                viewBox="0 0 19 18"
                className={`${transparent ? "transition-all ease-in-out group-hover:[&amp;_path]:fill-interactiveForegroundInversePrimary [&amp;_path]:fill-white h-3 w-3 md:h-4 md:w-4" : "transition-all ease-in-out group-hover:[&_path]:fill-interactiveForegroundInversePrimary h-3 w-3 md:h-4 md:w-4"}`}
                fill="#fff"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
                  d="M18.5 13.5L18.5 17C18.5 17.55 18.05 18 17.5 18C8.11 18 0.500002 10.39 0.500002 1C0.500002 0.450001 0.950003 0 1.5 0L4.99 0C5.54 0 5.99 0.450001 5.99 1C5.99 2.24 6.19 3.45 6.56 4.57C6.6 4.67 6.61 4.78 6.61 4.88C6.61 5.14 6.51 5.39 6.32 5.59L4.12 7.79C5.57 10.62 7.88 12.94 10.71 14.38L12.91 12.18C13.19 11.9 13.58 11.82 13.93 11.93C15.05 12.3 16.25 12.5 17.5 12.5C18.05 12.5 18.5 12.95 18.5 13.5Z"
                  fill={`${transparent ? "#fff" : "#292B29"}`}
                ></path>
              </svg>
            </div>
            <div className="absolute invisible left-1 min-[520px]:left-auto right-0 pt-2 group-hover:visible">
              <div className="bg-backgroundTertiary px-10 py-7 rounded-base w-80 shadow-md">
                Call us anytime at
                <a className="underline hover:text-textHighlight" href="tel:4155238837">
                  415-523-8837
                </a>
              </div>
            </div>
          ...
          <a
            className={`inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-bold leading-normal disabled:pointer-events-none disabled:opacity-50 transition-all ease-in-out duration-200 ${
              transparent
                ? "bg-graphTertiary text-interactiveForegroundInversePrimary hover:text-interactiveForegroundPrimary"
                : "bg-backgroundInverseSecondary text-interactiveForegroundPrimary"
            } hover:bg-accentPrimary py-3 w-auto h-8 px-4 md:px-6 md:h-12`}
            href="/start"
          >
            Get started
          </a>
          ...
          <button
            className={`${
              transparent
                ? "group-hover:bg-backgroundSecondary group-hover:text-textPrimary text-textInversePrimary hover:text-textInversePrimary hover:bg-inherit"
                : "text-textPrimary hover:bg-backgroundSecondary group-hover:bg-backgroundSecondary"
            } xl:hidden flex items-center font-normal transition-all ease-in-out duration-300 `}
